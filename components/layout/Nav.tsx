          ...
          <div className="flex items-center justify-end gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-expanded={open}
                onClick={() => setOpen((v) => !v)}
                className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-sbe-electric text-sbe-ink transition-transform hover:-translate-y-0.5 md:hidden"
              >
                {open ? (
