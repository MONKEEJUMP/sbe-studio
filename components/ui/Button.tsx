...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border-2 border-sbe-ink bg-sbe-surface text-sbe-ink shadow-[0_6px_0_var(--sbe-cobalt)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-sbe-cobalt hover:text-white hover:shadow-[0_8px_0_var(--sbe-copper)] active:translate-y-0 active:shadow-[0_3px_0_var(--sbe-copper)]",
  ghost:
